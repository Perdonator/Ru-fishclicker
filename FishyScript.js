...
function showShop() {
	if (shopFlag === "true") {
	    ...
	    document.getElementById("shopBtn").innerHTML = "Скрыть магазин!";
		shopFlag = "false";
	} else if (shopFlag === "false") {
		document.getElementById("shop").style.display = "none";
	    document.getElementById("shopBtn").innerHTML = "Показать магазин!";
		shopFlag = "true";
	}
}
...
function changelogToggle() {
	if (clFlag === "true") {
	    ...
	    document.getElementById("clTog").innerHTML = "Скрыть список изменений!";
		clFlag = "false";
	} else if (clFlag === "false") {
		document.getElementById("changelog").style.display = "none";
	    document.getElementById("clTog").innerHTML = "Показать список изменений!";
		clFlag = "true";
	}
